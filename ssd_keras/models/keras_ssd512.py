...
def ssd_512(image_size,
    ...
    #ozgur
    if mc_dropout:
        conv1_1 = Dropout(dropout_size)(conv1_1, training=True)
    ...
    #ozgur
    if mc_dropout:
        conv2_1 = Dropout(dropout_size)(conv2_1, training=True)
    ...
    #ozgur
    if mc_dropout:
        conv3_1 = Dropout(dropout_size)(conv3_1, training=True)
    ...
    #ozgur
    if mc_dropout:
        conv4_1 = Dropout(dropout_size)(conv4_1, training=True)
    ...
    #ozgur
    if mc_dropout:
        conv5_1 = Dropout(dropout_size)(conv5_1, training=True)
    ...
    #ozgur
    if mc_dropout:
        conv6_1 = Dropout(dropout_size)(conv6_1, training=True)
    ...
    #ozgur
    if mc_dropout:
        conv7_1 = Dropout(dropout_size)(conv7_1, training=True)
    ...
    #ozgur
    if mc_dropout:
        conv8_1 = Dropout(dropout_size)(conv8_1, training=True)
    ...
    #ozgur
    if mc_dropout:
        conv9_1 = Dropout(dropout_size)(conv9_1, training=True)
    ...
    #ozgur
    if mc_dropout:
        conv10_1 = Dropout(dropout_size)(conv10_1, training=True)
